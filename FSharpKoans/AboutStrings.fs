...
module ``about strings`` =
    ...
    let FormattingStringValues() =
        ...
        AssertEquality message message
    ...
    let ApplyWhatYouLearned() =
        (* It's time to apply what you've learned so far. Fill in the function below to
         ...
         let funFacts fact = sprintf "%d doubled is %d, and %d tripled is %d!" fact (double fact) fact (triple fact)
         let funFactsAboutThree() = funFacts 3
         let funFactsAboutSix() = funFacts 6
